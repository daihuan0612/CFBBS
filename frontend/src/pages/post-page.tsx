							...
							<CardContent className="space-y-4">
								...
								{isEditing ? (
									<div className="space-y-3">
										...
										<MarkdownEditor content={editContent} setContent={setEditContent} placeholder="写下你的内容..." r2PublicUrl={config?.r2_public_url} userRole={user?.role} maxUploadSizeMb={config?.max_upload_size_mb || 500} />
